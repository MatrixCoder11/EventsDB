# EventsDB — Щоденник заходів

Десктопний застосунок для ведення журналу подій та заходів із системою авторизації та розмежуванням прав доступу. Розроблений у рамках курсової роботи з об'єктно-орієнтованого програмування на C#.
...
### Головне вікно користувача з роллю Viewer
![Головне вікно користувача з роллю Viewer](Assets/viewer_main.png)
